        ...
        <div class="w-full h-full grid md:grid-cols-2 justify-between items-center px-14">
          ...
          <div class="min-w-[296px] h-[229px] md:w-[276px] md:h-[229px] lg:w-[420px] lg:h-[229px] flex flex-col items-center justify-center">
            <div class="w-full h-full flex flex-col gap-8">
              <p class="text-2xl font-normal whitespace-nowrap">Login in to you account</p>
          ...
          <div class="min-w-[296px] h-[229px] md:w-[279px] md:h-[229px] lg:w-[420px] lg:h-[229px] pt-24 md:pt-0 flex flex-col items-center justify-center">
            <div class="w-full h-full flex flex-col gap-8">
              <p class="text-2xl font-normal whitespace-nowrap">Need an account?</p>
              <div class="flex flex-col gap-8">
              ...
              <form class="flex flex-col gap-4">
                ...
                <input type="checkbox" class="checkbox" />
                    <p class="text-xs lg:text-sm font-light lg:text-center pl-2">I would like to receive SMS notifications related to my orders</p>
                </div>
                <div class="flex">
                <input type="checkbox" class="checkbox" />
                    <p class="text-xs lg:text-sm font-light lg:text-center pl-2">I wish to receive VTex Experience news on my e-mail</p>
                </div>
                <div class="flex">
                <input type="checkbox" class="checkbox" />
                    <p class="text-xs lg:text-sm font-light lg:text-center pl-2">I accept the Privacy Statement</p>
                </div>
              </form>
              <button class="flex items-center justify-center rounded-2xl lg:rounded-xl bg-pink py-3 md:min-w-[276px] lg:min-w-[420px] md:max-w-[142px] h-[48px] border text-black font-semibold border-pink hover:text-pink hover:bg-midnightblue transition-all duration-150 mt-4">
                Register
