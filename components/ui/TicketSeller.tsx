...
export default function TicketSeller() {
  return (
    <div class="flex flex-col text-center min-w-[100px] min-h-[193px] sm:min-w-[207px] sm:min-h-[160px] bg-gradient-to-b from-darkgray/20 to-darkgray/40 rounded-xl backdrop-blur-xl bg-opacity-20 items-center justify-center sm:items-start sm:justify-start p-4">
      ...
      <div class="flex flex-col md:flex-row items-center justify-center md:items-start md:justify-start align-middle pt-4 md:pt-2 gap-2.5 md:gap-1">
        <QuantitySelector quantity={0} />

        <button class="flex items-center justify-center rounded-2xl lg:rounded-xl py-3 min-w-full md:min-w-[88px] h-[44px] border text-white font-semibold border-pink hover:bg-pink transition-all duration-150">
