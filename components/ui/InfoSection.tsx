    ...
    <section class="flex w-full h-full lg:min-h-[980px] py-12 px-2 lg:px-0">
      <div class="flex flex-col w-full items-center justify-center">
        <div class="lg:max-w-4xl w-full flex items-center justify-between gap-6 md:gap-0 px-4 md:px-20 lg:px-0 relative">
          ...
          <div class="flex flex-col items-center justify-center md:items-stretch md:justify-stretch text-center md:text-start max-w-full md:max-w-[65%] lg:max-w-[547px]">
            <h1 class="text-white text-2xl md:text-[32px] text-[40px]">
              {title}
            </h1>
        ...
        <div class="bg-line-gradient w-[90%] h-1 mt-32" loading="lazy" />
      </div>
    </section>
  );
}
